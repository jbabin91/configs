...
export async function getInitalProjectContext(): Promise<ProjectContext> {
...
export async function applyEnabledFeatures(context: ProjectContext) {
  for (const feature of context.enabledFeatures) {
    addAllToSet(context.ignoredPaths, feature.ignorePaths);
    addAllToSet(context.gitIgnoredPaths, feature.gitIgnorePaths);
    addAllToSet(context.lintIgnoredPaths, feature.lintIgnorePaths);
    addAllToSet(context.typecheckIgnoredPaths, feature.typecheckIgnorePaths);
    addAllToSet(context.formatIgnoredPaths, feature.formatIgnorePaths);
  }
